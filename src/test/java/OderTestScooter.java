...
import ru.yandex.OrderScooter;

@RunWith(Parameterized.class)
public class OderTestScooter {
    ...
    public OderTestScooter(String username, String surname, String address, String phonenumber) {
    ...
    public static String[][] gerOrderData() {
        return new String[][]{
                {"Лена", "НеЛена", "Куромская 14", "+23232323232"},
                {"Петя", "НеПетя", "Москва", "89225400000"}
        };
    }
